...
<body>
    <div id="wrapper">
     ...
     <div class="panel-body">
         <div class="row">
             <div class="col-lg-6">
                 <form role="form" action="LapController?data=user&proses=update-lap" method="post">
                     <%
                  String ket = request.getParameter("no_lapangan");
      ...
      <div class="form-group">
           <input class="form-control" type="hidden" placeholder="Enter ID" name="no_lapangan" value="<%=data.get(0).getNoLap()%>" >
      </div>
          <div class="form-group">
          <label for="uname"><b>Kind of Field</b></label>
           <input class="form-control" type="text" placeholder="Enter Name" name="jenis_lapangan" value="<%=data.get(0).getJenisLap()%>" required>
      </div>
      <div class="form-group">
      <label for="psw"><b>Price</b></label>
      <input class="form-control" type="text" placeholder="Enter price" name="tarif" value="<%=data.get(0).getTarif()%>" required>
      </div>
      <div class="form-group">
      <label for="psw"><b>Wide</b></label>
      <input class="form-control" type="text" placeholder="Enter Wide" name="luas" value="<%=data.get(0).getLuas()%>" required>
      </div>
