            ...
            <div class="row">
              ...
              %>
               <tr>
                  ...
                  <td><%=data.get(x).getJenisLap()%></td>
                  <td><%=data.get(x).getTarif()%></td>
                  <td><%=data.get(x).getLuas()%></td>
                      
                  <td>
                      <a href="LapController?proses=edit-lap&no_lapangan=<%=data.get(x).getNoLap()%>"><button class="btn btn-lg btn-success btn-block">Edit</button></a>
