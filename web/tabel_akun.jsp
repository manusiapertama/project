<%-- 
    Document   : tabel_akun
    Created on : Jul 1, 2019, 1:20:01 PM
    Author     : asus
--%>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                 <!--  page header -->
                <div class="col-lg-12">
                    <h1 class="page-header">Account Table</h1>
                </div>
                 </div>
            <a href="form_akun.jsp"><button class="Tambah">Tambah</button></a>
            <div class="row">
                <div class="col-lg-12">
                    <!-- Advanced Tables -->
              ...
              %>
               <tr>
                  ...
                  <td><%=data.get(x).getRole()%></td>
                      
                  <td>
                      <a href="RegisController?proses=edit-user&id_akun=<%=data.get(x).getIdAkun()%>"><button class="btn btn-lg btn-success btn-block">Edit</button></a>
                      <a href="RegisController?proses=hapus-user&id_akun=<%=data.get(x).getIdAkun()%>"><button class="btn btn-lg btn-success btn-block">Hapus</button></a>
                  </td>
              </tr>
                                </tbody>
                                <%}%>
