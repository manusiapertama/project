<%-- 
    Document   : form_booking
    Created on : Jul 1, 2019, 11:11:33 PM
    Author     : asus
--%>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                 <!--  page header -->
                <div class="col-lg-12">
                    <h1 class="page-header">Add Booking Form</h1>
                </div>
                 </div>
           <div class="row">
                <div class="col-lg-12">
      ...
      <div class="panel-body">
         <div class="row">
             <div class="col-lg-6">
                 <form role="form" action="AdminBookController?data=user&proses=input-booking" method="post">
    
      <div class="form-group">
              <input type="text" name="nama_tim" class="form-control" id="contact-name" placeholder="Your Team Name" data-rule="minlen:4" data-msg="Please enter at least 4 chars">
            ...
            <div class="form-group">
              <input type="date" name="hari" class="form-control" id="contact-name" placeholder="Insert Day" data-rule="day" data-msg="Please enter a day">
              <div class="validate"></div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              <button class="btn btn-lg btn-success btn-block" type="submit" value="add">Add</button>
            </div>
         </form>
      </div>
